...
["Hytteturen er et eksemplar, der indgår i den disciplinære matrix, og som socialiserer nye studerende til datalogiens paradigme"],
...
"Hvis ikke jeg gør det vil andre tage min plads som rusvejleder",
...
["Procedurelle sprog og objektorienterede sprog er delmængder af mængden af imperative sprog",
...
["Finanskrisen havde karakter af en videnskabelig revolution",
...
regel_tekst = "Du skal til eksamen og øver dig på nogle huskeregler om begreber, der ifølge "+kragh_6b_title+" beskriver modellers fejlrate. "
regel_tekst += "Modellen forudsiger observationer som positive eller negative, og modellens forudsigelser kan være rigtige eller forkerte. "
regel_tekst += "Accuracy er antallet af alle korrekte forudsigelser, divideret med alle observationer. Hvad skal der stå på stregen? "
regel_tekst_1 = regel_tekst + ">>____ er ligesom accuracy, hvis vi kun tæller de observationer, der faktisk er positive<<"

qs.append(Question(regel_tekst_1,
["Recall"],
["Precision",
"Specificity",
"F1"],
...
regel_tekst_2 = regel_tekst + ">> ____ er ligesom accuracy, hvis vi kun tæller de observationer, der blev forudsagt som positive<<"

qs.append(Question(regel_tekst_2,
["Precision"],
["Recall",
"Specificity",
"F1"],
...
regel_tekst_3 = regel_tekst + ">>____ er ligesom accuracy, hvis vi kun tælller de observationer, der faktisk er negative"

qs.append(Question(regel_tekst_3,
["Specificity"],
["Precision",
"Recall",
"F1"],
...
qs.append(Question("Vi skal begrunde et etisk valg. Hvilken form for begrundelse indgår ikke i Nagels syntese",
["Begrundelser baseret på værdifrie observationer"],
["Agentneutrale begrundelser",
"Agentrelative begrundelser",
"Deontologiske begrundelser",
"Autonome begrundelser",
"Begrundelser i form af særlige forpligtelser"],
kragh_10_title))

neut_list = ["Maksimering af den størst mulige lykke",
"Skabe en tilstand, som alle kunne enes om, såfrem de placeredes bag uvidenhedens slør"]
rel_list = ["Deontologiske begrundelser - andres ret til ikke at blive behandlet dårligt af mig",
"Autonome livsprojekter",
"Begrundelser i form af særlige forpligtelser såsom tilhørsforhold til en familie"]

qs.append(Question("Vi skal begrunde et etisk valg ved anvendelse af Nagels syntese. Hvad er ikke en agentrelativ begrundelse?",
neut_list,
rel_list,
kragh_10_title))

qs.append(Question("Vi skal begrunde et etisk valg ved anvendelse af Nagels syntese. Hvad er ikke en agentneutral begrundelse?",
rel_list,
neut_list,
kragh_10_title))

qs.append(Question("Hvilken sætning refererer til Rawls tanker om uvidenhedens slør?",
["Retfærdighed opnås, hvis vi enes om en fordeling af samfundets goder mellem individer, før vi ved, hvilket individ vi selv skal fødes som",
"Relativ ulighed kan accepteres hvis det absolutte niveau for samfundets fattigste forbedres"],
["Manglende investeringer i grundforskning reducerer innovation",
"Grundlæggende skolegang er en universel ret og forpligtelse",
"Perioder, hvor den relative ulighed forøges, er sjældent historiske perioder med fremgang"],
kragh_10_title))

qs.append(Question("Hvad beviste Darley og Batson?",
["Selv små ændringer i miljøet kan gøre en stor forskel for de etiske valg, som individer træffer i praksis"],
["Handlinger kan være onde men individer er altid banale"],
kragh_10_title))

qs.append(Question("Hvad er >>Big Data-skellet<< som omtalt af Mittelstadt og Floridis?",
["Asymmetri i magt og viden i brugen af Big Data"],
["GDPR stopper ved landegrænser",
"Data, der omhandler datasubjekter i EU, er omfattet af GDPR",
"Der er store forskelle i de digitale kompetencer på tværs af alder og uddannelse"],
kragh_10_title))

qs.append(Question(kragh_10_title+" p. 3 viser et Venn-diagram, hvor det er etisk bedst at befinde sig i fællesmængden af de tre cirkler. Hvad repræsenterer cirklerne?",
["Etik, jura, praksis"],
["Nytteetik, pligtetik, Nagels syntese",
"Handling, konsekvens, nytte",
"Jura, praksis, konsekvens",
"Stikord, vane, belønning",
"Tese, antitese, syntese",
"Redegør, analyser, diskuter",
"Problem, løsning, konsekvens"],
...
qs.append(Question("Hvad er ikke et af de temaer i debatten om data-etik, som Mittelstadt og Floridis har identificeret?",
["Data som kultur versus data i kultur",
"Ontologi"],
["Informeret samtykke",
"Privacy",
"Ejerskab",
...
qs.append(Question("Hvad er ikke en del af Nagels skabelon for etiske beslutninger som beskrevet af Christiansen (2015)?",
["Overvej hvilken løsning, der stiller de svageste aktører bedst, målt i absolutte enheder",
"Tag ansvar for dine egne handlinger og erkend, at du ikke kan overskue disse handlingers konsekvenser",
"Betragt situationen gennem uvidenhedens slør"],
["Identificér hvori det etiske dilemma består",
"Identificer hvilke etiske grundværdier, der er i konflikt med hinanden",
"Identificer konfliktens interessenter",
"Undersøg ikke-etiske perspektiver såsom konkret empirisk viden",
"Overvej løsning der indebærer respekt for alle de etiske intuitioner, der er involveret"],
kragh_10_title))
...
print("Denne quiz er udarbejdet af Tim Mondorf som studerende på faget Datalogiens Videnskabsteori i blok 4 2023, beskrevet på https:///kurser.ku.dk//course//nndb19000u//2022-2023")
print("Faget blev udbudt som del af BSc Machine Learning og Data Science på Datalogisk Institutet, Københavns Universitet (DIKU)")
print("Undervisere i faget var Henrik Kragh Sørensen, Mikkel Willum Johansen og Josefine Pallavicini")
print("Kilder er Henrik Kragh Sørensen og Mikkel Willum Johansen Invitation til de datalogiske fags videnskabsteori og øvrig obligatorisk litteratur i VT-Dat 2023, jf. kursusrummet på Absalon")
print("Testen er udviklet som eksamensforberedelse til multiple choice-prøve. Quizzen og eventuelle fejl er Tim Mondorfs ansvar")
print("Tast 1, 2, 3 eller 4 for den ønskede svarmulighed eller 0 for afslutning.")
print("Der er "+str(len(qs))+" spørgsmål")
print()

def report_errors():
    if len(sources_of_error) >0 :
        print("Dine forkerte svar relaterer sig til følgende kilder i pensum: ")
        soe = []
        for s in source_list:
            if s in sources_of_error:
                soe.append((sources_of_error.count(s), s))
        soe.sort(reverse=True)
        for s in soe:
            print(s[1]+": "+str(s[0]))
...
for q in qs:
    ...
    resulto = q.perform_q()
    if resulto == -7:
        print("Din samlede score er "+str(score)+" ud af "+str(n-1)+" spørgsmål.")
        report_errors()
        quit()
    else:
        score += resulto
        ...
        print()
print("Din samlede score er "+str(score)+ " ud af "+str(n))
report_errors()
